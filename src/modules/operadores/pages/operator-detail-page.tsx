...
import { Clock, DollarSign, TrendingDown, ArrowUpRight } from 'lucide-react'
    ...
    <div>
      ...
      {ledger && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <AppStatCard title="Adiantamentos" value={<AppMoney value={Number(ledger.total_advances)} />} icon={ArrowUpRight} />
          <AppStatCard
            title="Saldo"
